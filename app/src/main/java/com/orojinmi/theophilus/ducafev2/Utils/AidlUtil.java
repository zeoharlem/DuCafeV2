package com.orojinmi.theophilus.ducafev2.Utils;
...
public class AidlUtil {
    ...
    *打印图片
     ...
     *  打印图片和文字按照指定排列顺序
     */
    public void printTextBitmap(Bitmap bitmap, int orientation, LinkedList<TableItem> list, String paidBy, String agent, String date, String transactcode) {
        if (woyouService == null) {
            Toast.makeText(context,"服务已断开！",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            if(orientation == 0){
                woyouService.printBitmap(bitmap, null);
                woyouService.printTextWithFont("\nDominican University Ib.\n", "ProximaNova-Black", 30, null);
                //woyouService.printBitmap(bitmap, null);
                woyouService.printText("10, Educational Zone, Ibadan\n", null);
                woyouService.printText(".............................\n", null);
                for (TableItem tableItem : list) {
                    woyouService.printColumnsString(tableItem.getText(), tableItem.getWidth(), tableItem.getAlign(), null);
                }
                woyouService.printText(".............................\n", null);
                woyouService.printText(transactcode+"\n", null);
                woyouService.printText(".............................\n", null);
                woyouService.printText("Paid By: " + paidBy + " \n", null);
                woyouService.printText("Agent: " + agent + " \n", null);
                woyouService.printText(date+" \n", null);
            }
     ...
     * 打印表格
     */
    public void printTable(LinkedList<TableItem> list, ICallback iCallback) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            for (TableItem tableItem : list) {
                ...
                woyouService.printColumnsString(tableItem.getText(), tableItem.getWidth(), tableItem.getAlign(), iCallback);
            }
            woyouService.lineWrap(3, iCallback);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
     ...
     * 打印表格
     */
    public void printTableByBuffer(LinkedList<TableItem> list, ICallback iCallback) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
